...
} from "strapi-plugin-content-manager/admin/src/utils";
...
function Filter({
  ...
  if (attributeType === "relation") {
    type = get(
      contentType,
      ["metadatas", name, "list", "mainField", "schema", "type"],
      "string"
    );
  }
...
Filter.propTypes = {
  contentType: PropTypes.shape({ attributes: PropTypes.object.isRequired })
    .isRequired,
